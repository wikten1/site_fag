...
> Este catálogo é a referência visual preservada. Os tokens e estilos efetivamente publicados estão em `assets/css/`; consulte [a arquitetura atual](architecture.md).
...
| Logo FAG | [Logo.png](../references/images/Logo.png) |
| Fotografia do hero e fechamento | `../references/templates/clenecs ref/assets/22dd7a232342672b_0b9f293f-1d43-45a5-8afa-a26a82.png` |
| Iconify | `../references/templates/clenecs ref/assets/2aca3a415088b0b0_iconify-icon.min.js` |
| GSAP | `../references/templates/clenecs ref/assets/5468a19b889d2341_gsap.min.js` |
| ScrollTrigger | `../references/templates/clenecs ref/assets/d705d104381eeb97_ScrollTrigger.min.js` |
