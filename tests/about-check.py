...
with sync_playwright() as p:
    ...
    try:
        ...
        assert page.locator('.about-related-row').first.get_attribute('href') == 'https://fag.tangua.rj.gov.br/convenios/'
        ...
        assert page.locator('.about-related-row').first.evaluate('(link) => link === document.activeElement')
